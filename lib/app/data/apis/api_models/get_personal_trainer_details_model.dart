class GetPersonalTrainerDetailsModel {
  Result? result;
  String? message;
  String? status;

  GetPersonalTrainerDetailsModel({this.result, this.message, this.status});

  GetPersonalTrainerDetailsModel.fromJson(Map<String, dynamic> json) {
    result =
