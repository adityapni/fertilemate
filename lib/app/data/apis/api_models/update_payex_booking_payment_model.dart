class UpdatePayexBookingPaymentModel {
  Data? data;
  String? message;
  String? status;

  UpdatePayexBookingPaymentModel({this.data, this.message, this.status});

  UpdatePayexBookingPaymentModel.fromJson(Map<String, dynamic> json) {
