...
class TvsClinicDetailModel {
  ...
  TvsClinicDetailModel.fromJson(dynamic json) {
    _data = json['data'] != null ? TvsClinicDetailData.fromJson(json['data']) : null;
    _message = json['message'];
    _status = json['status'];
  }
  TvsClinicDetailData? _data;
  String? _message;
  String? _status;
TvsClinicDetailModel copyWith({  TvsClinicDetailData? data,
  String? message,
  String? status,
}) => TvsClinicDetailModel(  data: data ?? _data,
  message: message ?? _message,
  status: status ?? _status,
);
  TvsClinicDetailData? get data => _data;
...
/// clinic_image : "https://server-php-8-2.technorizen.com/nuru/public/uploads/available_test/sdf324.png"
...
class TvsClinicDetailData {
  ...
  TvsClinicDetailData.fromJson(dynamic json) {
  ...
  num? _clients;
  String? _rating;
  TvsClinicDetailData copyWith({  String? clinicId,
  String? clinicName,
  String? clinicImage,
  String? clinicAddress,
  String? clinicMonday,
  ...
  num? clients,
  String? rating,
}) => TvsClinicDetailData(  clinicId: clinicId ?? _clinicId,
