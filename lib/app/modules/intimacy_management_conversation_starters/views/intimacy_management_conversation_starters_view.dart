...
class IntimacyManagementConversationStartersView
    extends GetView<IntimacyManagementConversationStartersController> {
  const IntimacyManagementConversationStartersView({Key? key})
      : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (controller.result.isNotEmpty)
                      Text(
                        StringConstants.discoverNewTopicsToDeepenYourConnection,
                        style:
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        StringConstants
                                            .exploreEachOthersDesiresAndFantasies,
                                        maxLines: 3,
                                      ...
                                      CommonWidgets.commonElevatedButton(
                                        ...
                                        onPressed: () =>
                                            controller.clickOnStartNowButton(),
                                        child: Text(
