...
class CycleTrackingSecondController extends GetxController {
  final count = 0.obs;
  ...
  clickOnContinueButton() {
    Map<String, String> parameter = {
      ApiKeyConstants.id:
          result[selectedCard.value].id.toString()
    };
    Get.toNamed(Routes.CYCLE_TRACKING_THIRD, parameters: parameter);
  }
