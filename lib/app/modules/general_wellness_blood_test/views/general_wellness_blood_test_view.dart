...
class GeneralWellnessBloodTestView
    extends GetView<GeneralWellnessBloodTestController> {
  const GeneralWellnessBloodTestView({Key? key}) : super(key: key);
            ...
            child: Column(
              children: [
                ...
                (controller.availableTest.isNotEmpty)
                    ...
                    : controller.generalAvailableTestsModel == null
                        ? const SizedBox()
                        : Center(
