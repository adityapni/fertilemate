...
class GeneralWellnessBloodTestController extends GetxController {
  final count = 0.obs;

  final inAsyncCall = false.obs;

  AvailableTestsModel? generalAvailableTestsModel;
  ...
  Future<void> availableTestsApi() async {
    generalAvailableTestsModel = await ApiMethods.generalAvailableTests();
    if (generalAvailableTestsModel != null &&
        generalAvailableTestsModel!.availableTest != null &&
        generalAvailableTestsModel!.availableTest!.isNotEmpty) {
      availableTest = generalAvailableTestsModel!.availableTest!;
    }
  }
