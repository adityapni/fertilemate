...
class BookYourClassView extends GetView<BookYourClassController> {
  const BookYourClassView({Key? key}) : super(key: key);
              ...
              child: Card(
                ...
                child: SizedBox(
                  ...
                  child: ScrollableCleanCalendar(
                    ...
                    daySelectedBackgroundColor: Theme.of(context).primaryColor,
                    dayRadius: 20.px,
                    // showWeekdays: false,
                    ...
                    monthTextStyle: Theme.of(context)
                        ...
                        .displayMedium
                        ?.copyWith(fontSize: 14.px),
                    weekdayTextStyle: Theme.of(context).textTheme.titleSmall,
