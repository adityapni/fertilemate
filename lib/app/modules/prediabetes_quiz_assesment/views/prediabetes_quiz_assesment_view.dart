...
class PrediabetesQuizAssesmentView
    extends GetView<PrediabetesQuizAssesmentController> {
  const PrediabetesQuizAssesmentView({Key? key}) : super(key: key);
            ...
            child: Row(
                ...
                children: [
                  ...
                  (controller.currentPageIndex.value !=
                          controller
                                  .getPrediabetesAssessmentQuestionData.length -
                              1)
                      ? FloatingActionButton(
                          backgroundColor: Theme.of(context).primaryColor,
                          shape: OutlineInputBorder(
          ...
          body: Center(
            child: Padding(
              ...
              child: Container(
                ...
                child: controller
                        .getPrediabetesAssessmentQuestionData.isNotEmpty
                    ? PageView.builder(
                        onPageChanged: (value) {
