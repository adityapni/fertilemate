...
class ExpertConsultationBookingDetailsView
    extends GetView<ExpertConsultationBookingDetailsController> {
  const ExpertConsultationBookingDetailsView({Key? key}) : super(key: key);
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    StringConstants.bookYourAppointment,
                    maxLines: 1,
